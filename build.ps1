...
$sourceDir = "D:\a\oneui-desktop-widgets\oneui-desktop-widgets\samsung-widgets-win32-x64"
...
& $lightPath "build\windows\samsung-widgets.wixobj", "GeneratedFile.wxs" "-o" "bin\samsung-widgets.msi"
